...
import ClothesFilter from '../../components/filter/ClothesFilter'

function Clothes() {
    const context = useContext(myContext)
    const { mode, clothe, searchkey, setSearchkey, filterType, setFilterType,
    ...
    return (
        <Layout>
            <div>
                <h1 class="flex justify-center items-center text-3xl font-medium title-font my-10 text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>Clothes</h1>
                <ClothesFilter />
                <section className="text-gray-600 body-font">
                    <div className="container px-5 py-8 md:py-16 mx-auto">

                        <div className="flex justify-center flex-wrap -m-4">
                            {clothe.filter((obj) => obj.title.toLowerCase().includes(searchkey))
