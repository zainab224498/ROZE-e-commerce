...
function Shoeses() {
    ...
    const { mode, shoes, searchkey, setSearchkey, filterType, setFilterType,
    ...
    return (
        <Layout>
            <div>
                <h1 class="flex justify-center items-center text-3xl font-medium title-font my-10 text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>Shoes</h1>
                <ShoesFilter />
