...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    try {
      // Open PayPal site in a new window with specific window features and your account ID in the URL
      const accountId = 'AVUaXWHpa10C0n7dLoHYfGQ62enSluY2vJtBYNcEZGJ_3U07Q1itpI-rJCdXcoVNQn-8M5wGScdfm1gB';
      const url = `https://www.paypal.com/${accountId}`;
      const win = window.open(url, '_blank', 'width=400,height=300,top=100,left=100');
  
      // Handle the payment completion after window is closed
      const paymentCompletionInterval = setInterval(() => {
        if (win.closed) {
          clearInterval(paymentCompletionInterval);
          ...
          const orderInfo = {
            ...
            paymentId: 'PayPal Payment ID', // Replace with the actual PayPal payment ID
          };
      ...
      console.log(error);
      toast.error('Failed to open PayPal site');
    }
  }; 
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "AVUaXWHpa10C0n7dLoHYfGQ62enSluY2vJtBYNcEZGJ_3U07Q1itpI-rJCdXcoVNQn-8M5wGScdfm1gB",
      key_secret: "AVUaXWHpa10C0n7dLoHYfGQ62enSluY2vJtBYNcEZGJ_3U07Q1itpI-rJCdXcoVNQn-8M5wGScdfm1gB",
    ...
    <Layout >
      <div className=" bg-gray-100 pt-5" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          ...
          <div className="mt-6 mb-10 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
