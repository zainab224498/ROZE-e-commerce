...
function AccessoriesFilter() {
    ...
    const { mode, searchkey, setSearchkey, filterType, setFilterType,
        filterPrice, setFilterPrice, accessory } = context
    return (
...
"  style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div>
                    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
                        ...
                        >
                            {[...new Set(accessory.map((item) => item.category))].map((category, index) => (
                        ...
                        >
                            {[...new Set(accessory.map((item) => item.price))].map((price, index) => (
