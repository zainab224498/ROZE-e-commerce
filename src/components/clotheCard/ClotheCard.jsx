...
function ClotheCard() {
    ...
    const { mode, clothe, searchkey, filterType,
        filterPrice } = context;
        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-8 md:py-16 mx-auto">
                <div class=" flex justify-center items-center flex-col  mb-6 lg:mb-10">
                    <h1 class="sm:text-5xl text-2xl font-medium title-font mb-4 p-2 bg-gradient-to-r from-pink-600 via-pink-200 to-fuchsia-500 text-transparent bg-clip-text animate-gradient">Our Latest Clothes</h1>
                </div>
